...
export default class ClassesController {
  ...
  async index(request: Request, response: Response) {
    // possui tres filtros: dias da semana, materia, horario
  ...
  async create(request: Request, response: Response) {
    ...
    try {
      ...
      const user_id = insertedUsersIds[0]; // pegando o primeiro que foi inserido
      ...
      // desfaz as operacoes caso ocorra algum erro
      await trx.rollback();
